...
export function PhoneIcon({ width = 18, height = 18 }: { width?: number; height?: number }) {
  return (
...
export function MailIcon({ width = 18, height = 18 }: { width?: number; height?: number }) {
  return (
    <svg width={width} height={height} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
...
export function PinIcon({ width = 18, height = 18 }: { width?: number; height?: number }) {
  return (
...
export function GoogleGIcon({ size = 20, className }: { size?: number; className?: string }) {
  return (
