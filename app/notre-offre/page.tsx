            ...
            <article className="opt-card opt-card--ads reveal d1">
              <div className="opt-head">
                <span className="opt-ic opt-ic--google">
                  <svg width="28" height="28" viewBox="0 0 24 24" fill="none"><rect x="8.6" y="1.5" width="6" height="15" rx="3" transform="rotate(-30 11.6 9)" fill="#FBBC04" /><rect x="11" y="7" width="6" height="15" rx="3" transform="rotate(30 14 14.5)" fill="#4285F4" /><circle cx="7.4" cy="17.6" r="3.3" fill="#34A853" /></svg>
                </span>
                <div>
